...
@StockCategoryCreation
Scenario Outline: Stock Category Creation Functionality Validation
When Open Browser
...
And Wait for Addbutton with "xpath" and "(//a[@data-caption='Add'])[1]" with time "10"
...
And Enter Category Name as "<CategoryName>" with "xpath" and "//input[@id='x_Category_Name']"
...
Then user validate the Stock Category table with "<CategoryName>"
